...
EMAIL_HOST = config('H_EMAIL_HOST')  # Użyj serwera SMTP (np. Gmail)
...
RECAPTCHA_SECRET_KEY = config("RECAP_SECRET_KEY_TEST")
RECAPTCHA_SITE_KEY = config("RECAP_SITE_KEY_TEST")

FRONTEND_BASE_URL = "http://localhost:3000"


#powyzsze klucze sluza do testowania recap lokalnie, musisz je podmienic potem

#DEFAULT_FROM_EMAIL = 'Portfolio App <noreply@yourdomain.com>' TO BEDZIE DO ZMIANY, ZAMIAST SWOJEGA MAILA EMAIL DOMENY
